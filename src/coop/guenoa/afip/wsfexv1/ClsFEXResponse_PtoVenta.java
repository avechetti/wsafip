...
public class ClsFEXResponse_PtoVenta implements java.io.Serializable {
	...
	public ClsFEXResponse_PtoVenta(short pve_Nro, java.lang.String pve_Bloqueado, java.lang.String pve_FchBaja) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ClsFEXResponse_PtoVenta))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.pve_Nro == other.getPve_Nro()
				&& ((this.pve_Bloqueado == null && other.getPve_Bloqueado() == null)
						|| (this.pve_Bloqueado != null && this.pve_Bloqueado.equals(other.getPve_Bloqueado())))
				&& ((this.pve_FchBaja == null && other.getPve_FchBaja() == null)
						|| (this.pve_FchBaja != null && this.pve_FchBaja.equals(other.getPve_FchBaja())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ClsFEXResponse_PtoVenta.class, true);
