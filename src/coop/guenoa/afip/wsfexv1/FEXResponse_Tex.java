...
public class FEXResponse_Tex implements java.io.Serializable {
	private coop.guenoa.afip.wsfexv1.ClsFEXResponse_Tex[] FEXResultGet;

	private coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr;

	private coop.guenoa.afip.wsfexv1.ClsFEXEvents FEXEvents;

	public FEXResponse_Tex() {
	}

	public FEXResponse_Tex(coop.guenoa.afip.wsfexv1.ClsFEXResponse_Tex[] FEXResultGet, coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr,
	...
	/**
	 * Gets the FEXResultGet value for this FEXResponse_Tex.
	 * 
	 * @return FEXResultGet
	 */
	public coop.guenoa.afip.wsfexv1.ClsFEXResponse_Tex[] getFEXResultGet() {
		return FEXResultGet;
	}

	/**
	 * Sets the FEXResultGet value for this FEXResponse_Tex.
	 * 
	 * @param FEXResultGet
	 */
	public void setFEXResultGet(coop.guenoa.afip.wsfexv1.ClsFEXResponse_Tex[] FEXResultGet) {
		this.FEXResultGet = FEXResultGet;
	}

	/**
	 * Gets the FEXErr value for this FEXResponse_Tex.
	 * 
	 * @return FEXErr
	 */
	...
	/**
	 * Sets the FEXErr value for this FEXResponse_Tex.
	 * 
	 * @param FEXErr
	 */
	...
	/**
	 * Gets the FEXEvents value for this FEXResponse_Tex.
	 * 
	 * @return FEXEvents
	 */
	...
	/**
	 * Sets the FEXEvents value for this FEXResponse_Tex.
	 * 
	 * @param FEXEvents
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FEXResponse_Tex))
			return false;
		FEXResponse_Tex other = (FEXResponse_Tex) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FEXResponse_Tex.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "FEXResponse_Tex"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Tex"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Tex"));
