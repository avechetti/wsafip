...
public class FEXResponse_Umed implements java.io.Serializable {
	private coop.guenoa.afip.wsfexv1.ClsFEXResponse_UMed[] FEXResultGet;

	private coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr;

	private coop.guenoa.afip.wsfexv1.ClsFEXEvents FEXEvents;

	public FEXResponse_Umed() {
	}

	public FEXResponse_Umed(coop.guenoa.afip.wsfexv1.ClsFEXResponse_UMed[] FEXResultGet, coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr,
	 ...
	 * @return FEXResultGet
	 */
	public coop.guenoa.afip.wsfexv1.ClsFEXResponse_UMed[] getFEXResultGet() {
		return FEXResultGet;
	}
	 ...
	 * @param FEXResultGet
	 */
	public void setFEXResultGet(coop.guenoa.afip.wsfexv1.ClsFEXResponse_UMed[] FEXResultGet) {
		this.FEXResultGet = FEXResultGet;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FEXResponse_Umed))
			return false;
		FEXResponse_Umed other = (FEXResponse_Umed) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FEXResponse_Umed.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "FEXResponse_Umed"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_UMed"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_UMed"));
