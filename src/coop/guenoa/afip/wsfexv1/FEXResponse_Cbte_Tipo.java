...
public class FEXResponse_Cbte_Tipo implements java.io.Serializable {
	private coop.guenoa.afip.wsfexv1.ClsFEXResponse_Cbte_Tipo[] FEXResultGet;

	private coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr;

	private coop.guenoa.afip.wsfexv1.ClsFEXEvents FEXEvents;

	public FEXResponse_Cbte_Tipo() {
	}

	public FEXResponse_Cbte_Tipo(coop.guenoa.afip.wsfexv1.ClsFEXResponse_Cbte_Tipo[] FEXResultGet, coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr,
	...
	/**
	 * Gets the FEXResultGet value for this FEXResponse_Cbte_Tipo.
	 * 
	 * @return FEXResultGet
	 */
	public coop.guenoa.afip.wsfexv1.ClsFEXResponse_Cbte_Tipo[] getFEXResultGet() {
		return FEXResultGet;
	}

	/**
	 * Sets the FEXResultGet value for this FEXResponse_Cbte_Tipo.
	 * 
	 * @param FEXResultGet
	 */
	public void setFEXResultGet(coop.guenoa.afip.wsfexv1.ClsFEXResponse_Cbte_Tipo[] FEXResultGet) {
		this.FEXResultGet = FEXResultGet;
	}

	/**
	 * Gets the FEXErr value for this FEXResponse_Cbte_Tipo.
	 * 
	 * @return FEXErr
	 */
	...
	/**
	 * Sets the FEXErr value for this FEXResponse_Cbte_Tipo.
	 * 
	 * @param FEXErr
	 */
	...
	/**
	 * Gets the FEXEvents value for this FEXResponse_Cbte_Tipo.
	 * 
	 * @return FEXEvents
	 */
	...
	/**
	 * Sets the FEXEvents value for this FEXResponse_Cbte_Tipo.
	 * 
	 * @param FEXEvents
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FEXResponse_Cbte_Tipo))
			return false;
		FEXResponse_Cbte_Tipo other = (FEXResponse_Cbte_Tipo) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FEXResponse_Cbte_Tipo.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "FEXResponse_Cbte_Tipo"));
		...
		elemField
				.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Cbte_Tipo"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(
				new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Cbte_Tipo"));
