...
public class ClsFEXResponse_DST_cuit implements java.io.Serializable {
	...
	public ClsFEXResponse_DST_cuit(long DST_CUIT, java.lang.String DST_Ds) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ClsFEXResponse_DST_cuit))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.DST_CUIT == other.getDST_CUIT() && ((this.DST_Ds == null && other.getDST_Ds() == null)
				|| (this.DST_Ds != null && this.DST_Ds.equals(other.getDST_Ds())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ClsFEXResponse_DST_cuit.class, true);
