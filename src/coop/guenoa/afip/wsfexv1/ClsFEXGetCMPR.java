...
public class ClsFEXGetCMPR implements java.io.Serializable {
	...
	private coop.guenoa.afip.wsfexv1.Permiso[] permisos;
	...
	private coop.guenoa.afip.wsfexv1.Cmp_asoc[] cmps_asoc;
	...
	private coop.guenoa.afip.wsfexv1.Item[] items;
	...
	public ClsFEXGetCMPR(long id, java.lang.String fecha_cbte, short cbte_tipo, short punto_vta, long cbte_nro,
			short tipo_expo, java.lang.String permiso_existente, coop.guenoa.afip.wsfexv1.Permiso[] permisos, short dst_cmp,
			java.lang.String cliente, long cuit_pais_cliente, java.lang.String domicilio_cliente,
			java.lang.String id_impositivo, java.lang.String moneda_Id, java.math.BigDecimal moneda_ctz,
			java.lang.String obs_comerciales, java.math.BigDecimal imp_total, java.lang.String obs,
			coop.guenoa.afip.wsfexv1.Cmp_asoc[] cmps_asoc, java.lang.String forma_pago, java.lang.String incoterms,
			java.lang.String incoterms_Ds, short idioma_cbte, coop.guenoa.afip.wsfexv1.Item[] items, java.lang.String fecha_cbte_cae,
			java.lang.String fch_venc_Cae, java.lang.String cae, java.lang.String resultado,
	 ...
	 * @return permisos
	 */
	public coop.guenoa.afip.wsfexv1.Permiso[] getPermisos() {
		return permisos;
	}
	 ...
	 * @param permisos
	 */
	public void setPermisos(coop.guenoa.afip.wsfexv1.Permiso[] permisos) {
		this.permisos = permisos;
	}
	 ...
	 * @return cmps_asoc
	 */
	public coop.guenoa.afip.wsfexv1.Cmp_asoc[] getCmps_asoc() {
		return cmps_asoc;
	}
	 ...
	 * @param cmps_asoc
	 */
	public void setCmps_asoc(coop.guenoa.afip.wsfexv1.Cmp_asoc[] cmps_asoc) {
		this.cmps_asoc = cmps_asoc;
	}
	 ...
	 * @return items
	 */
	public coop.guenoa.afip.wsfexv1.Item[] getItems() {
		return items;
	}
	 ...
	 * @param items
	 */
	public void setItems(coop.guenoa.afip.wsfexv1.Item[] items) {
		this.items = items;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ClsFEXGetCMPR))
			return false;
		...
		_equals = true && this.id == other.getId()
				...
				&& this.cbte_tipo == other.getCbte_tipo() && this.punto_vta == other.getPunto_vta()
				&& this.cbte_nro == other.getCbte_nro() && this.tipo_expo == other.getTipo_expo()
				...
				&& ((this.permisos == null && other.getPermisos() == null)
						|| (this.permisos != null && java.util.Arrays.equals(this.permisos, other.getPermisos())))
				...
				&& ((this.id_impositivo == null && other.getId_impositivo() == null)
						|| (this.id_impositivo != null && this.id_impositivo.equals(other.getId_impositivo())))
				&& ((this.moneda_Id == null && other.getMoneda_Id() == null)
						|| (this.moneda_Id != null && this.moneda_Id.equals(other.getMoneda_Id())))
				&& ((this.moneda_ctz == null && other.getMoneda_ctz() == null)
						|| (this.moneda_ctz != null && this.moneda_ctz.equals(other.getMoneda_ctz())))
				&& ((this.obs_comerciales == null && other.getObs_comerciales() == null)
						|| (this.obs_comerciales != null && this.obs_comerciales.equals(other.getObs_comerciales())))
				&& ((this.imp_total == null && other.getImp_total() == null)
						|| (this.imp_total != null && this.imp_total.equals(other.getImp_total())))
				&& ((this.obs == null && other.getObs() == null)
						|| (this.obs != null && this.obs.equals(other.getObs())))
				&& ((this.cmps_asoc == null && other.getCmps_asoc() == null)
						|| (this.cmps_asoc != null && java.util.Arrays.equals(this.cmps_asoc, other.getCmps_asoc())))
				&& ((this.forma_pago == null && other.getForma_pago() == null)
						|| (this.forma_pago != null && this.forma_pago.equals(other.getForma_pago())))
				&& ((this.incoterms == null && other.getIncoterms() == null)
						|| (this.incoterms != null && this.incoterms.equals(other.getIncoterms())))
				&& ((this.incoterms_Ds == null && other.getIncoterms_Ds() == null)
						|| (this.incoterms_Ds != null && this.incoterms_Ds.equals(other.getIncoterms_Ds())))
				...
				&& ((this.motivos_Obs == null && other.getMotivos_Obs() == null)
						|| (this.motivos_Obs != null && this.motivos_Obs.equals(other.getMotivos_Obs())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getPermisos() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getPermisos()); i++) {
		...
		if (getCmps_asoc() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getCmps_asoc()); i++) {
