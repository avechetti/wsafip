...
public class FEXResponse_Mon implements java.io.Serializable {
	private coop.guenoa.afip.wsfexv1.ClsFEXResponse_Mon[] FEXResultGet;

	private coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr;

	private coop.guenoa.afip.wsfexv1.ClsFEXEvents FEXEvents;

	public FEXResponse_Mon() {
	}

	public FEXResponse_Mon(coop.guenoa.afip.wsfexv1.ClsFEXResponse_Mon[] FEXResultGet, coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr,
	 ...
	 * @return FEXResultGet
	 */
	public coop.guenoa.afip.wsfexv1.ClsFEXResponse_Mon[] getFEXResultGet() {
		return FEXResultGet;
	}
	 ...
	 * @param FEXResultGet
	 */
	public void setFEXResultGet(coop.guenoa.afip.wsfexv1.ClsFEXResponse_Mon[] FEXResultGet) {
		this.FEXResultGet = FEXResultGet;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FEXResponse_Mon))
			return false;
		FEXResponse_Mon other = (FEXResponse_Mon) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FEXResponse_Mon.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "FEXResponse_Mon"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Mon"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Mon"));
