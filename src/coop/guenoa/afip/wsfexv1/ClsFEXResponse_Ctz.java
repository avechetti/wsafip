...
public class ClsFEXResponse_Ctz implements java.io.Serializable {
	...
	public ClsFEXResponse_Ctz(java.math.BigDecimal mon_ctz, java.lang.String mon_fecha) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ClsFEXResponse_Ctz))
			return false;
		...
		_equals = true
				&& ((this.mon_ctz == null && other.getMon_ctz() == null)
						|| (this.mon_ctz != null && this.mon_ctz.equals(other.getMon_ctz())))
				&& ((this.mon_fecha == null && other.getMon_fecha() == null)
						|| (this.mon_fecha != null && this.mon_fecha.equals(other.getMon_fecha())));
		__equalsCalc = null;
		return _equals;
	}
