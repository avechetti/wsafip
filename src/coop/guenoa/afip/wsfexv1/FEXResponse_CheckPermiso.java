...
public class FEXResponse_CheckPermiso implements java.io.Serializable {
	private coop.guenoa.afip.wsfexv1.ClsFEXResponse_CheckPermiso FEXResultGet;

	private coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr;

	private coop.guenoa.afip.wsfexv1.ClsFEXEvents FEXEvents;

	public FEXResponse_CheckPermiso() {
	}

	public FEXResponse_CheckPermiso(coop.guenoa.afip.wsfexv1.ClsFEXResponse_CheckPermiso FEXResultGet, coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr,
	 ...
	 * @return FEXResultGet
	 */
	public coop.guenoa.afip.wsfexv1.ClsFEXResponse_CheckPermiso getFEXResultGet() {
		return FEXResultGet;
	}
	 ...
	 * @param FEXResultGet
	 */
	public void setFEXResultGet(coop.guenoa.afip.wsfexv1.ClsFEXResponse_CheckPermiso FEXResultGet) {
		this.FEXResultGet = FEXResultGet;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FEXResponse_CheckPermiso))
			return false;
		FEXResponse_CheckPermiso other = (FEXResponse_CheckPermiso) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FEXResponse_CheckPermiso.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "FEXResponse_CheckPermiso"));
		...
		elemField.setXmlType(
				new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_CheckPermiso"));
