...
public class FEXResponse_Inc implements java.io.Serializable {
	private coop.guenoa.afip.wsfexv1.ClsFEXResponse_Inc[] FEXResultGet;

	private coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr;

	private coop.guenoa.afip.wsfexv1.ClsFEXEvents FEXEvents;

	public FEXResponse_Inc() {
	}

	public FEXResponse_Inc(coop.guenoa.afip.wsfexv1.ClsFEXResponse_Inc[] FEXResultGet, coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr,
	...
	/**
	 * Gets the FEXResultGet value for this FEXResponse_Inc.
	 * 
	 * @return FEXResultGet
	 */
	public coop.guenoa.afip.wsfexv1.ClsFEXResponse_Inc[] getFEXResultGet() {
		return FEXResultGet;
	}

	/**
	 * Sets the FEXResultGet value for this FEXResponse_Inc.
	 * 
	 * @param FEXResultGet
	 */
	public void setFEXResultGet(coop.guenoa.afip.wsfexv1.ClsFEXResponse_Inc[] FEXResultGet) {
		this.FEXResultGet = FEXResultGet;
	}

	/**
	 * Gets the FEXErr value for this FEXResponse_Inc.
	 * 
	 * @return FEXErr
	 */
	...
	/**
	 * Sets the FEXErr value for this FEXResponse_Inc.
	 * 
	 * @param FEXErr
	 */
	...
	/**
	 * Gets the FEXEvents value for this FEXResponse_Inc.
	 * 
	 * @return FEXEvents
	 */
	...
	/**
	 * Sets the FEXEvents value for this FEXResponse_Inc.
	 * 
	 * @param FEXEvents
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FEXResponse_Inc))
			return false;
		FEXResponse_Inc other = (FEXResponse_Inc) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FEXResponse_Inc.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "FEXResponse_Inc"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Inc"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Inc"));
