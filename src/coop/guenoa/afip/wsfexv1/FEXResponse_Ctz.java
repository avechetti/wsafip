...
public class FEXResponse_Ctz implements java.io.Serializable {
	private coop.guenoa.afip.wsfexv1.ClsFEXResponse_Ctz FEXResultGet;

	private coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr;

	private coop.guenoa.afip.wsfexv1.ClsFEXEvents FEXEvents;

	public FEXResponse_Ctz() {
	}

	public FEXResponse_Ctz(coop.guenoa.afip.wsfexv1.ClsFEXResponse_Ctz FEXResultGet, coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr,
	...
	/**
	 * Gets the FEXResultGet value for this FEXResponse_Ctz.
	 * 
	 * @return FEXResultGet
	 */
	public coop.guenoa.afip.wsfexv1.ClsFEXResponse_Ctz getFEXResultGet() {
		return FEXResultGet;
	}

	/**
	 * Sets the FEXResultGet value for this FEXResponse_Ctz.
	 * 
	 * @param FEXResultGet
	 */
	public void setFEXResultGet(coop.guenoa.afip.wsfexv1.ClsFEXResponse_Ctz FEXResultGet) {
		this.FEXResultGet = FEXResultGet;
	}

	/**
	 * Gets the FEXErr value for this FEXResponse_Ctz.
	 * 
	 * @return FEXErr
	 */
	...
	/**
	 * Sets the FEXErr value for this FEXResponse_Ctz.
	 * 
	 * @param FEXErr
	 */
	...
	/**
	 * Gets the FEXEvents value for this FEXResponse_Ctz.
	 * 
	 * @return FEXEvents
	 */
	...
	/**
	 * Sets the FEXEvents value for this FEXResponse_Ctz.
	 * 
	 * @param FEXEvents
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FEXResponse_Ctz))
			return false;
		FEXResponse_Ctz other = (FEXResponse_Ctz) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FEXResponse_Ctz.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "FEXResponse_Ctz"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Ctz"));
