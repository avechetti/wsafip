...
public class FEXResponse_Idi implements java.io.Serializable {
	private coop.guenoa.afip.wsfexv1.ClsFEXResponse_Idi[] FEXResultGet;

	private coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr;

	private coop.guenoa.afip.wsfexv1.ClsFEXEvents FEXEvents;

	public FEXResponse_Idi() {
	}

	public FEXResponse_Idi(coop.guenoa.afip.wsfexv1.ClsFEXResponse_Idi[] FEXResultGet, coop.guenoa.afip.wsfexv1.ClsFEXErr FEXErr,
	...
	/**
	 * Gets the FEXResultGet value for this FEXResponse_Idi.
	 * 
	 * @return FEXResultGet
	 */
	public coop.guenoa.afip.wsfexv1.ClsFEXResponse_Idi[] getFEXResultGet() {
		return FEXResultGet;
	}

	/**
	 * Sets the FEXResultGet value for this FEXResponse_Idi.
	 * 
	 * @param FEXResultGet
	 */
	public void setFEXResultGet(coop.guenoa.afip.wsfexv1.ClsFEXResponse_Idi[] FEXResultGet) {
		this.FEXResultGet = FEXResultGet;
	}

	/**
	 * Gets the FEXErr value for this FEXResponse_Idi.
	 * 
	 * @return FEXErr
	 */
	...
	/**
	 * Sets the FEXErr value for this FEXResponse_Idi.
	 * 
	 * @param FEXErr
	 */
	...
	/**
	 * Gets the FEXEvents value for this FEXResponse_Idi.
	 * 
	 * @return FEXEvents
	 */
	...
	/**
	 * Sets the FEXEvents value for this FEXResponse_Idi.
	 * 
	 * @param FEXEvents
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FEXResponse_Idi))
			return false;
		FEXResponse_Idi other = (FEXResponse_Idi) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FEXResponse_Idi.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "FEXResponse_Idi"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Idi"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Idi"));
