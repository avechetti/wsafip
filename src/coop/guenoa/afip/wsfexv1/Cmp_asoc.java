...
public class Cmp_asoc implements java.io.Serializable {
	...
	public Cmp_asoc(short cbte_tipo, short cbte_punto_vta, long cbte_nro, long cbte_cuit) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.cbte_tipo == other.getCbte_tipo() && this.cbte_punto_vta == other.getCbte_punto_vta()
				&& this.cbte_nro == other.getCbte_nro() && this.cbte_cuit == other.getCbte_cuit();
		__equalsCalc = null;
		return _equals;
	}
