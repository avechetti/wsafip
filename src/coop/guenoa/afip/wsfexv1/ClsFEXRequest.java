...
public class ClsFEXRequest implements java.io.Serializable {
	...
	public ClsFEXRequest(long id, java.lang.String fecha_cbte, short cbte_Tipo, short punto_vta, long cbte_nro,
			...
			java.lang.String incoterms_Ds, short idioma_cbte, coop.guenoa.afip.wsfexv1.Item[] items) {
		this.id = id;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ClsFEXRequest))
			return false;
		...
		_equals = true && this.id == other.getId()
				...
				&& this.idioma_cbte == other.getIdioma_cbte() && ((this.items == null && other.getItems() == null)
