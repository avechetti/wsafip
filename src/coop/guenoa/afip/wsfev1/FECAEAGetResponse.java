...
public class FECAEAGetResponse implements java.io.Serializable {
	private coop.guenoa.afip.wsfev1.FECAEAGet resultGet;

	private coop.guenoa.afip.wsfev1.Err[] errors;

	private coop.guenoa.afip.wsfev1.Evt[] events;

	public FECAEAGetResponse() {
	}

	public FECAEAGetResponse(coop.guenoa.afip.wsfev1.FECAEAGet resultGet, coop.guenoa.afip.wsfev1.Err[] errors, coop.guenoa.afip.wsfev1.Evt[] events) {
	...
	/**
	 * Gets the resultGet value for this FECAEAGetResponse.
	 * 
	 * @return resultGet
	 */
	public coop.guenoa.afip.wsfev1.FECAEAGet getResultGet() {
		return resultGet;
	}

	/**
	 * Sets the resultGet value for this FECAEAGetResponse.
	 * 
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wsfev1.FECAEAGet resultGet) {
		this.resultGet = resultGet;
	}

	/**
	 * Gets the errors value for this FECAEAGetResponse.
	 * 
	 * @return errors
	 */
	...
	/**
	 * Sets the errors value for this FECAEAGetResponse.
	 * 
	 * @param errors
	 */
	...
	/**
	 * Gets the events value for this FECAEAGetResponse.
	 * 
	 * @return events
	 */
	...
	/**
	 * Sets the events value for this FECAEAGetResponse.
	 * 
	 * @param events
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FECAEAGetResponse))
			return false;
		FECAEAGetResponse other = (FECAEAGetResponse) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FECAEAGetResponse.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "FECAEAGetResponse"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "FECAEAGet"));
