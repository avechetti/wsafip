...
public class ServiceLocator extends org.apache.axis.client.Service implements coop.guenoa.afip.wsfev1.IService {
	...
	public ServiceLocator(Boolean homologacion) {
		if (homologacion) {
			ServiceSoap_address = "https://wswhomo.afip.gov.ar/wsfev1/service.asmx";
		} else {
			ServiceSoap_address = "";
		}
	...
	public coop.guenoa.afip.wsfev1.IServiceWsfeV1 getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
		try {
			coop.guenoa.afip.wsfev1.ServiceSoapStub _stub = new coop.guenoa.afip.wsfev1.ServiceSoapStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (coop.guenoa.afip.wsfev1.IServiceWsfeV1.class.isAssignableFrom(serviceEndpointInterface)) {
				coop.guenoa.afip.wsfev1.ServiceSoapStub _stub = new coop.guenoa.afip.wsfev1.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
				_stub.setPortName(getServiceSoapWSDDServiceName());
				return _stub;
			}
