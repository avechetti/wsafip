...
public class FECAEARequest implements java.io.Serializable {
	private coop.guenoa.afip.wsfev1.FECAEACabRequest feCabReq;

	private coop.guenoa.afip.wsfev1.FECAEADetRequest[] feDetReq;

	public FECAEARequest() {
	}

	public FECAEARequest(coop.guenoa.afip.wsfev1.FECAEACabRequest feCabReq, coop.guenoa.afip.wsfev1.FECAEADetRequest[] feDetReq) {
	 ...
	 * @return feCabReq
	 */
	public coop.guenoa.afip.wsfev1.FECAEACabRequest getFeCabReq() {
		return feCabReq;
	}
	 ...
	 * @param feCabReq
	 */
	public void setFeCabReq(coop.guenoa.afip.wsfev1.FECAEACabRequest feCabReq) {
		this.feCabReq = feCabReq;
	}
	 ...
	 * @return feDetReq
	 */
	public coop.guenoa.afip.wsfev1.FECAEADetRequest[] getFeDetReq() {
		return feDetReq;
	}
	 ...
	 * @param feDetReq
	 */
	public void setFeDetReq(coop.guenoa.afip.wsfev1.FECAEADetRequest[] feDetReq) {
		this.feDetReq = feDetReq;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FECAEARequest))
			return false;
		...
		_equals = true
				&& ((this.feCabReq == null && other.getFeCabReq() == null)
						|| (this.feCabReq != null && this.feCabReq.equals(other.getFeCabReq())))
				&& ((this.feDetReq == null && other.getFeDetReq() == null)
						|| (this.feDetReq != null && java.util.Arrays.equals(this.feDetReq, other.getFeDetReq())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getFeDetReq() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getFeDetReq()); i++) {
