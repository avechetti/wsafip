...
public class FERecuperaLastCbteResponse implements java.io.Serializable {
	...
	public FERecuperaLastCbteResponse(coop.guenoa.afip.wsfev1.Err[] errors, int ptoVta, int cbteTipo, int cbteNro, coop.guenoa.afip.wsfev1.Evt[] events) {
		this.errors = errors;
		this.ptoVta = ptoVta;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FERecuperaLastCbteResponse))
			return false;
		...
		_equals = true
				...
				&& this.cbteNro == other.getCbteNro() && ((this.events == null && other.getEvents() == null)
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FERecuperaLastCbteResponse.class, true);

	static {
		typeDesc.setXmlType(
				new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "FERecuperaLastCbteResponse"));
