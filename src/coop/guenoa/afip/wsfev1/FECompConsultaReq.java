...
public class FECompConsultaReq implements java.io.Serializable {
	...
	public FECompConsultaReq(int cbteTipo, long cbteNro, int ptoVta) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FECompConsultaReq))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.cbteTipo == other.getCbteTipo() && this.cbteNro == other.getCbteNro()
