...
public class CbteTipoResponse implements java.io.Serializable {
	private coop.guenoa.afip.wsfev1.CbteTipo[] resultGet;
	...
	public CbteTipoResponse(coop.guenoa.afip.wsfev1.CbteTipo[] resultGet, coop.guenoa.afip.wsfev1.Err[] errors, coop.guenoa.afip.wsfev1.Evt[] events) {
	 ...
	 * @return resultGet
	 */
	public coop.guenoa.afip.wsfev1.CbteTipo[] getResultGet() {
		return resultGet;
	}
	 ...
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wsfev1.CbteTipo[] resultGet) {
		this.resultGet = resultGet;
	}
	...
	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "CbteTipoResponse"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "CbteTipo"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "CbteTipo"));
