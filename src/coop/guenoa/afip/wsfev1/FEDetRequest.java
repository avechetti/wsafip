...
public class FEDetRequest implements java.io.Serializable {
	...
	private coop.guenoa.afip.wsfev1.CbteAsoc[] cbtesAsoc;

	private coop.guenoa.afip.wsfev1.Tributo[] tributos;

	private coop.guenoa.afip.wsfev1.AlicIva[] iva;

	private coop.guenoa.afip.wsfev1.Opcional[] opcionales;

	public FEDetRequest() {
	}

	public FEDetRequest(int concepto, int docTipo, long docNro, long cbteDesde, long cbteHasta,
	 ...
	 * @return cbtesAsoc
	 */
	public coop.guenoa.afip.wsfev1.CbteAsoc[] getCbtesAsoc() {
		return cbtesAsoc;
	}
	 ...
	 * @param cbtesAsoc
	 */
	public void setCbtesAsoc(coop.guenoa.afip.wsfev1.CbteAsoc[] cbtesAsoc) {
		this.cbtesAsoc = cbtesAsoc;
	}
	 ...
	 * @return tributos
	 */
	public coop.guenoa.afip.wsfev1.Tributo[] getTributos() {
		return tributos;
	}
	 ...
	 * @param tributos
	 */
	public void setTributos(coop.guenoa.afip.wsfev1.Tributo[] tributos) {
		this.tributos = tributos;
	}
	 ...
	 * @return iva
	 */
	public coop.guenoa.afip.wsfev1.AlicIva[] getIva() {
		return iva;
	}
	 ...
	 * @param iva
	 */
	public void setIva(coop.guenoa.afip.wsfev1.AlicIva[] iva) {
		this.iva = iva;
	}
	 ...
	 * @return opcionales
	 */
	public coop.guenoa.afip.wsfev1.Opcional[] getOpcionales() {
		return opcionales;
	}
	 ...
	 * @param opcionales
	 */
	public void setOpcionales(coop.guenoa.afip.wsfev1.Opcional[] opcionales) {
		this.opcionales = opcionales;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FEDetRequest))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.concepto == other.getConcepto() && this.docTipo == other.getDocTipo()
				&& this.docNro == other.getDocNro() && this.cbteDesde == other.getCbteDesde()
				...
				&& this.impTotal == other.getImpTotal() && this.impTotConc == other.getImpTotConc()
				&& this.impNeto == other.getImpNeto() && this.impOpEx == other.getImpOpEx()
				&& this.impTrib == other.getImpTrib() && this.impIVA == other.getImpIVA()
				&& ((this.fchServDesde == null && other.getFchServDesde() == null)
						|| (this.fchServDesde != null && this.fchServDesde.equals(other.getFchServDesde())))
				&& ((this.fchServHasta == null && other.getFchServHasta() == null)
						|| (this.fchServHasta != null && this.fchServHasta.equals(other.getFchServHasta())))
				&& ((this.fchVtoPago == null && other.getFchVtoPago() == null)
						|| (this.fchVtoPago != null && this.fchVtoPago.equals(other.getFchVtoPago())))
				...
				&& ((this.cbtesAsoc == null && other.getCbtesAsoc() == null)
						|| (this.cbtesAsoc != null && java.util.Arrays.equals(this.cbtesAsoc, other.getCbtesAsoc())))
				&& ((this.tributos == null && other.getTributos() == null)
						|| (this.tributos != null && java.util.Arrays.equals(this.tributos, other.getTributos())))
				&& ((this.iva == null && other.getIva() == null)
						|| (this.iva != null && java.util.Arrays.equals(this.iva, other.getIva())))
	...
	public synchronized int hashCode() {
		...
		if (getCbtesAsoc() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getCbtesAsoc()); i++) {
		...
		if (getTributos() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getTributos()); i++) {
		...
		if (getIva() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getIva()); i++) {
