...
public class FECAEASinMovConsResponse implements java.io.Serializable {
	private coop.guenoa.afip.wsfev1.FECAEASinMov[] resultGet;

	private coop.guenoa.afip.wsfev1.Err[] errors;

	private coop.guenoa.afip.wsfev1.Evt[] events;

	public FECAEASinMovConsResponse() {
	}

	public FECAEASinMovConsResponse(coop.guenoa.afip.wsfev1.FECAEASinMov[] resultGet, coop.guenoa.afip.wsfev1.Err[] errors, coop.guenoa.afip.wsfev1.Evt[] events) {
	...
	/**
	 * Gets the resultGet value for this FECAEASinMovConsResponse.
	 * 
	 * @return resultGet
	 */
	public coop.guenoa.afip.wsfev1.FECAEASinMov[] getResultGet() {
		return resultGet;
	}

	/**
	 * Sets the resultGet value for this FECAEASinMovConsResponse.
	 * 
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wsfev1.FECAEASinMov[] resultGet) {
		this.resultGet = resultGet;
	}

	/**
	 * Gets the errors value for this FECAEASinMovConsResponse.
	 * 
	 * @return errors
	 */
	...
	/**
	 * Sets the errors value for this FECAEASinMovConsResponse.
	 * 
	 * @param errors
	 */
	...
	/**
	 * Gets the events value for this FECAEASinMovConsResponse.
	 * 
	 * @return events
	 */
	...
	/**
	 * Sets the events value for this FECAEASinMovConsResponse.
	 * 
	 * @param events
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FECAEASinMovConsResponse))
			return false;
		FECAEASinMovConsResponse other = (FECAEASinMovConsResponse) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FECAEASinMovConsResponse.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "FECAEASinMovConsResponse"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "FECAEASinMov"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "FECAEASinMov"));
