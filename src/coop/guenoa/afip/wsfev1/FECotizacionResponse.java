...
public class FECotizacionResponse implements java.io.Serializable {
	private coop.guenoa.afip.wsfev1.Cotizacion resultGet;

	private coop.guenoa.afip.wsfev1.Err[] errors;

	private coop.guenoa.afip.wsfev1.Evt[] events;

	public FECotizacionResponse() {
	}

	public FECotizacionResponse(coop.guenoa.afip.wsfev1.Cotizacion resultGet, coop.guenoa.afip.wsfev1.Err[] errors, coop.guenoa.afip.wsfev1.Evt[] events) {
	...
	/**
	 * Gets the resultGet value for this FECotizacionResponse.
	 * 
	 * @return resultGet
	 */
	public coop.guenoa.afip.wsfev1.Cotizacion getResultGet() {
		return resultGet;
	}

	/**
	 * Sets the resultGet value for this FECotizacionResponse.
	 * 
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wsfev1.Cotizacion resultGet) {
		this.resultGet = resultGet;
	}

	/**
	 * Gets the errors value for this FECotizacionResponse.
	 * 
	 * @return errors
	 */
	...
	/**
	 * Sets the errors value for this FECotizacionResponse.
	 * 
	 * @param errors
	 */
	...
	/**
	 * Gets the events value for this FECotizacionResponse.
	 * 
	 * @return events
	 */
	...
	/**
	 * Sets the events value for this FECotizacionResponse.
	 * 
	 * @param events
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FECotizacionResponse))
			return false;
		FECotizacionResponse other = (FECotizacionResponse) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
		...
		_equals = true
				&& ((this.resultGet == null && other.getResultGet() == null)
						|| (this.resultGet != null && this.resultGet.equals(other.getResultGet())))
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FECotizacionResponse.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "FECotizacionResponse"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "Cotizacion"));
