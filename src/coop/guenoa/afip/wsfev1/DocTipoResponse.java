...
public class DocTipoResponse implements java.io.Serializable {
	private coop.guenoa.afip.wsfev1.DocTipo[] resultGet;
	...
	public DocTipoResponse(coop.guenoa.afip.wsfev1.DocTipo[] resultGet, coop.guenoa.afip.wsfev1.Err[] errors, coop.guenoa.afip.wsfev1.Evt[] events) {
	 ...
	 * @return resultGet
	 */
	public coop.guenoa.afip.wsfev1.DocTipo[] getResultGet() {
		return resultGet;
	}
	 ...
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wsfev1.DocTipo[] resultGet) {
		this.resultGet = resultGet;
	}
	...
	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "DocTipoResponse"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "DocTipo"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "DocTipo"));
