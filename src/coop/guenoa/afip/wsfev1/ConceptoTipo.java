...
public class ConceptoTipo implements java.io.Serializable {
	private int id;
	...
	public ConceptoTipo(int id, java.lang.String desc, java.lang.String fchDesde, java.lang.String fchHasta) {
		this.id = id;
		this.desc = desc;
	...
	/**
	 * Gets the id value for this ConceptoTipo.
	 * 
	 * @return id
	 */
	public int getId() {
	...
	/**
	 * Sets the id value for this ConceptoTipo.
	 * 
	 * @param id
	 */
	...
	/**
	 * Gets the desc value for this ConceptoTipo.
	 * 
	 * @return desc
	 */
	...
	/**
	 * Sets the desc value for this ConceptoTipo.
	 * 
	 * @param desc
	 */
	...
	/**
	 * Gets the fchDesde value for this ConceptoTipo.
	 * 
	 * @return fchDesde
	 */
	...
	/**
	 * Sets the fchDesde value for this ConceptoTipo.
	 * 
	 * @param fchDesde
	 */
	...
	/**
	 * Gets the fchHasta value for this ConceptoTipo.
	 * 
	 * @return fchHasta
	 */
	...
	/**
	 * Sets the fchHasta value for this ConceptoTipo.
	 * 
	 * @param fchHasta
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ConceptoTipo))
			return false;
		ConceptoTipo other = (ConceptoTipo) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ConceptoTipo.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "ConceptoTipo"));
