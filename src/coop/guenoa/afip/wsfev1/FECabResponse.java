...
public class FECabResponse implements java.io.Serializable {
	...
	public FECabResponse(long cuit, int ptoVta, int cbteTipo, java.lang.String fchProceso, int cantReg,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FECabResponse))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.cuit == other.getCuit() && this.ptoVta == other.getPtoVta()
