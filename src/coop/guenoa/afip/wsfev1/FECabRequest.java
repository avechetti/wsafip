...
public class FECabRequest implements java.io.Serializable {
	...
	public FECabRequest(int cantReg, int ptoVta, int cbteTipo) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FECabRequest))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.cantReg == other.getCantReg() && this.ptoVta == other.getPtoVta()
