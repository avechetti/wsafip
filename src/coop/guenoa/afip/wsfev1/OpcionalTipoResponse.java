...
public class OpcionalTipoResponse implements java.io.Serializable {
	private coop.guenoa.afip.wsfev1.OpcionalTipo[] resultGet;
	...
	public OpcionalTipoResponse(coop.guenoa.afip.wsfev1.OpcionalTipo[] resultGet, coop.guenoa.afip.wsfev1.Err[] errors, coop.guenoa.afip.wsfev1.Evt[] events) {
	 ...
	 * @return resultGet
	 */
	public coop.guenoa.afip.wsfev1.OpcionalTipo[] getResultGet() {
		return resultGet;
	}
	 ...
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wsfev1.OpcionalTipo[] resultGet) {
		this.resultGet = resultGet;
	}
