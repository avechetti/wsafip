...
public class FECompConsResponse extends coop.guenoa.afip.wsfev1.FECAEDetRequest implements java.io.Serializable {
	...
	private coop.guenoa.afip.wsfev1.Obs[] observaciones;
	...
	public FECompConsResponse(int concepto, int docTipo, long docNro, long cbteDesde, long cbteHasta,
			...
			coop.guenoa.afip.wsfev1.Tributo[] tributos, coop.guenoa.afip.wsfev1.AlicIva[] iva, coop.guenoa.afip.wsfev1.Opcional[] opcionales, java.lang.String resultado,
			java.lang.String codAutorizacion, java.lang.String emisionTipo, java.lang.String fchVto,
			java.lang.String fchProceso, coop.guenoa.afip.wsfev1.Obs[] observaciones, int ptoVta, int cbteTipo) {
	 ...
	 */
	public coop.guenoa.afip.wsfev1.Obs[] getObservaciones() {
		return observaciones;
	}
	 ...
	 * @param observaciones
	 */
	public void setObservaciones(coop.guenoa.afip.wsfev1.Obs[] observaciones) {
		this.observaciones = observaciones;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FECompConsResponse))
			return false;
		...
		_equals = super.equals(obj)
				...
				&& ((this.emisionTipo == null && other.getEmisionTipo() == null)
						|| (this.emisionTipo != null && this.emisionTipo.equals(other.getEmisionTipo())))
				&& ((this.fchVto == null && other.getFchVto() == null)
						|| (this.fchVto != null && this.fchVto.equals(other.getFchVto())))
				...
				&& this.ptoVta == other.getPtoVta() && this.cbteTipo == other.getCbteTipo();
		__equalsCalc = null;
		return _equals;
	}
