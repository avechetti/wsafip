...
public class FEPaisResponse implements java.io.Serializable {
	private coop.guenoa.afip.wsfev1.PaisTipo[] resultGet;

	private coop.guenoa.afip.wsfev1.Err[] errors;

	private coop.guenoa.afip.wsfev1.Evt[] events;

	public FEPaisResponse() {
	}

	public FEPaisResponse(coop.guenoa.afip.wsfev1.PaisTipo[] resultGet, coop.guenoa.afip.wsfev1.Err[] errors, coop.guenoa.afip.wsfev1.Evt[] events) {
	...
	/**
	 * Gets the resultGet value for this FEPaisResponse.
	 * 
	 * @return resultGet
	 */
	public coop.guenoa.afip.wsfev1.PaisTipo[] getResultGet() {
		return resultGet;
	}

	/**
	 * Sets the resultGet value for this FEPaisResponse.
	 * 
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wsfev1.PaisTipo[] resultGet) {
		this.resultGet = resultGet;
	}

	/**
	 * Gets the errors value for this FEPaisResponse.
	 * 
	 * @return errors
	 */
	...
	/**
	 * Sets the errors value for this FEPaisResponse.
	 * 
	 * @param errors
	 */
	...
	/**
	 * Gets the events value for this FEPaisResponse.
	 * 
	 * @return events
	 */
	...
	/**
	 * Sets the events value for this FEPaisResponse.
	 * 
	 * @param events
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FEPaisResponse))
			return false;
		FEPaisResponse other = (FEPaisResponse) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FEPaisResponse.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "FEPaisResponse"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "PaisTipo"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "PaisTipo"));
