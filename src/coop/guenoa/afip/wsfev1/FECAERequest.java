...
public class FECAERequest implements java.io.Serializable {
	private coop.guenoa.afip.wsfev1.FECAECabRequest feCabReq;

	private coop.guenoa.afip.wsfev1.FECAEDetRequest[] feDetReq;

	public FECAERequest() {
	}

	public FECAERequest(coop.guenoa.afip.wsfev1.FECAECabRequest feCabReq, coop.guenoa.afip.wsfev1.FECAEDetRequest[] feDetReq) {
	 ...
	 * @return feCabReq
	 */
	public coop.guenoa.afip.wsfev1.FECAECabRequest getFeCabReq() {
		return feCabReq;
	}
	 ...
	 * @param feCabReq
	 */
	public void setFeCabReq(coop.guenoa.afip.wsfev1.FECAECabRequest feCabReq) {
		this.feCabReq = feCabReq;
	}
	 ...
	 * @return feDetReq
	 */
	public coop.guenoa.afip.wsfev1.FECAEDetRequest[] getFeDetReq() {
		return feDetReq;
	}
	 ...
	 * @param feDetReq
	 */
	public void setFeDetReq(coop.guenoa.afip.wsfev1.FECAEDetRequest[] feDetReq) {
		this.feDetReq = feDetReq;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FECAERequest))
			return false;
