...
public class FETributoResponse implements java.io.Serializable {
	private coop.guenoa.afip.wsfev1.TributoTipo[] resultGet;

	private coop.guenoa.afip.wsfev1.Err[] errors;

	private coop.guenoa.afip.wsfev1.Evt[] events;

	public FETributoResponse() {
	}

	public FETributoResponse(coop.guenoa.afip.wsfev1.TributoTipo[] resultGet, coop.guenoa.afip.wsfev1.Err[] errors, coop.guenoa.afip.wsfev1.Evt[] events) {
	...
	/**
	 * Gets the resultGet value for this FETributoResponse.
	 * 
	 * @return resultGet
	 */
	public coop.guenoa.afip.wsfev1.TributoTipo[] getResultGet() {
		return resultGet;
	}

	/**
	 * Sets the resultGet value for this FETributoResponse.
	 * 
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wsfev1.TributoTipo[] resultGet) {
		this.resultGet = resultGet;
	}

	/**
	 * Gets the errors value for this FETributoResponse.
	 * 
	 * @return errors
	 */
	...
	/**
	 * Sets the errors value for this FETributoResponse.
	 * 
	 * @param errors
	 */
	...
	/**
	 * Gets the events value for this FETributoResponse.
	 * 
	 * @return events
	 */
	...
	/**
	 * Sets the events value for this FETributoResponse.
	 * 
	 * @param events
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FETributoResponse))
			return false;
		FETributoResponse other = (FETributoResponse) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FETributoResponse.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "FETributoResponse"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "TributoTipo"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "TributoTipo"));
