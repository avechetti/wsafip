...
public class MonedaResponse implements java.io.Serializable {
	private coop.guenoa.afip.wsfev1.Moneda[] resultGet;
	...
	public MonedaResponse(coop.guenoa.afip.wsfev1.Moneda[] resultGet, coop.guenoa.afip.wsfev1.Err[] errors, coop.guenoa.afip.wsfev1.Evt[] events) {
	...
	/**
	 * Gets the resultGet value for this MonedaResponse.
	 * 
	 * @return resultGet
	 */
	public coop.guenoa.afip.wsfev1.Moneda[] getResultGet() {
		return resultGet;
	}

	/**
	 * Sets the resultGet value for this MonedaResponse.
	 * 
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wsfev1.Moneda[] resultGet) {
		this.resultGet = resultGet;
	}

	/**
	 * Gets the errors value for this MonedaResponse.
	 * 
	 * @return errors
	 */
	...
	/**
	 * Sets the errors value for this MonedaResponse.
	 * 
	 * @param errors
	 */
	...
	/**
	 * Gets the events value for this MonedaResponse.
	 * 
	 * @return events
	 */
	...
	/**
	 * Sets the events value for this MonedaResponse.
	 * 
	 * @param events
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof MonedaResponse))
			return false;
		MonedaResponse other = (MonedaResponse) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			MonedaResponse.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "MonedaResponse"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "Moneda"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.FEV1/", "Moneda"));
