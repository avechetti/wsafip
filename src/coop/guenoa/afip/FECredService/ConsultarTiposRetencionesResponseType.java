...
public class ConsultarTiposRetencionesResponseType implements java.io.Serializable {
	private coop.guenoa.afip.FECredService.ConsultarTiposRetencionesReturnType consultarTiposRetencionesReturn;

	public ConsultarTiposRetencionesResponseType() {
	}

	public ConsultarTiposRetencionesResponseType(
			coop.guenoa.afip.FECredService.ConsultarTiposRetencionesReturnType consultarTiposRetencionesReturn) {
		this.consultarTiposRetencionesReturn = consultarTiposRetencionesReturn;
	}

	/**
	 * Gets the consultarTiposRetencionesReturn value for this
	 * ConsultarTiposRetencionesResponseType.
	 * 
	 * @return consultarTiposRetencionesReturn
	 */
	public coop.guenoa.afip.FECredService.ConsultarTiposRetencionesReturnType getConsultarTiposRetencionesReturn() {
		return consultarTiposRetencionesReturn;
	}

	/**
	 * Sets the consultarTiposRetencionesReturn value for this
	 * ConsultarTiposRetencionesResponseType.
	 * 
	 * @param consultarTiposRetencionesReturn
	 */
	public void setConsultarTiposRetencionesReturn(
			coop.guenoa.afip.FECredService.ConsultarTiposRetencionesReturnType consultarTiposRetencionesReturn) {
		this.consultarTiposRetencionesReturn = consultarTiposRetencionesReturn;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ConsultarTiposRetencionesResponseType))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && ((this.consultarTiposRetencionesReturn == null
				&& other.getConsultarTiposRetencionesReturn() == null)
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ConsultarTiposRetencionesResponseType.class, true);
