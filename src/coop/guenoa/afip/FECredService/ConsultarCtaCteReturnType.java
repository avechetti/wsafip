...
public class ConsultarCtaCteReturnType implements java.io.Serializable {
	private coop.guenoa.afip.FECredService.CuentaCorrienteType ctaCte;
	...
	public ConsultarCtaCteReturnType(coop.guenoa.afip.FECredService.CuentaCorrienteType ctaCte,
	 ...
	 * @return ctaCte
	 */
	public coop.guenoa.afip.FECredService.CuentaCorrienteType getCtaCte() {
		return ctaCte;
	}
	 ...
	 * @param ctaCte
	 */
	public void setCtaCte(coop.guenoa.afip.FECredService.CuentaCorrienteType ctaCte) {
		this.ctaCte = ctaCte;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ConsultarCtaCteReturnType))
			return false;
		...
		_equals = true
				&& ((this.ctaCte == null && other.getCtaCte() == null)
						|| (this.ctaCte != null && this.ctaCte.equals(other.getCtaCte())))
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ConsultarCtaCteReturnType.class, true);
