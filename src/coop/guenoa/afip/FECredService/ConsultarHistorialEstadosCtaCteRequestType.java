/**
 * ConsultarHistorialEstadosCtaCteRequestType.java
 *
...
public class ConsultarHistorialEstadosCtaCteRequestType implements java.io.Serializable {
	...
	public ConsultarHistorialEstadosCtaCteRequestType() {
	}

	public ConsultarHistorialEstadosCtaCteRequestType(coop.guenoa.afip.FECredService.AuthRequestType authRequest,
	...
	/**
	 * Gets the idCtaCte value for this ConsultarHistorialEstadosCtaCteRequestType.
	 * 
	 * @return idCtaCte
	 */
	...
	/**
	 * Sets the idCtaCte value for this ConsultarHistorialEstadosCtaCteRequestType.
	 * 
	 * @param idCtaCte
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ConsultarHistorialEstadosCtaCteRequestType))
			return false;
		ConsultarHistorialEstadosCtaCteRequestType other = (ConsultarHistorialEstadosCtaCteRequestType) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ConsultarHistorialEstadosCtaCteRequestType.class, true);
