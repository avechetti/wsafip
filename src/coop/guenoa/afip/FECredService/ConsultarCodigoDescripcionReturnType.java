/**
 * ConsultarCodigoDescripcionReturnType.java
 *
...
public class ConsultarCodigoDescripcionReturnType implements java.io.Serializable {
	private coop.guenoa.afip.FECredService.CodigoDescripcionType[] arrayCodigoDescripcion;

	private coop.guenoa.afip.FECredService.CodigoDescripcionStringType[] arrayErroresFormato;

	public ConsultarCodigoDescripcionReturnType() {
	}

	public ConsultarCodigoDescripcionReturnType(
			coop.guenoa.afip.FECredService.CodigoDescripcionType[] arrayCodigoDescripcion,
			coop.guenoa.afip.FECredService.CodigoDescripcionStringType[] arrayErroresFormato) {
		this.arrayCodigoDescripcion = arrayCodigoDescripcion;
		this.arrayErroresFormato = arrayErroresFormato;
	}

	/**
	 * Gets the arrayCodigoDescripcion value for this
	 * ConsultarCodigoDescripcionReturnType.
	 * 
	 * @return arrayCodigoDescripcion
	 */
	public coop.guenoa.afip.FECredService.CodigoDescripcionType[] getArrayCodigoDescripcion() {
		return arrayCodigoDescripcion;
	}

	/**
	 * Sets the arrayCodigoDescripcion value for this
	 * ConsultarCodigoDescripcionReturnType.
	 * 
	 * @param arrayCodigoDescripcion
	 */
	public void setArrayCodigoDescripcion(
			coop.guenoa.afip.FECredService.CodigoDescripcionType[] arrayCodigoDescripcion) {
		this.arrayCodigoDescripcion = arrayCodigoDescripcion;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ConsultarCodigoDescripcionReturnType))
			return false;
		ConsultarCodigoDescripcionReturnType other = (ConsultarCodigoDescripcionReturnType) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
		...
		boolean _equals;
		_equals = true
				&& ((this.arrayCodigoDescripcion == null && other.getArrayCodigoDescripcion() == null)
						|| (this.arrayCodigoDescripcion != null && java.util.Arrays.equals(this.arrayCodigoDescripcion,
								other.getArrayCodigoDescripcion())))
	...
	public synchronized int hashCode() {
		...
		__hashCodeCalc = true;
		int _hashCode = 1;
		if (getArrayCodigoDescripcion() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getArrayCodigoDescripcion()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(getArrayCodigoDescripcion(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ConsultarCodigoDescripcionReturnType.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gob.afip.wsfecred/FECredService/",
				"ConsultarCodigoDescripcionReturnType"));
		org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
		elemField.setFieldName("arrayCodigoDescripcion");
		elemField.setXmlName(new javax.xml.namespace.QName("", "arrayCodigoDescripcion"));
