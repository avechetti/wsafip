...
public class ConsultarFacturasAgtDptoCltvRequestType implements java.io.Serializable {
	...
	private coop.guenoa.afip.FECredService.FiltroFechaType filtroFecha;

	public ConsultarFacturasAgtDptoCltvRequestType() {
	}

	public ConsultarFacturasAgtDptoCltvRequestType(coop.guenoa.afip.FECredService.AuthRequestType authRequest,
			coop.guenoa.afip.FECredService.IdCtaCteType idCtaCte,
			coop.guenoa.afip.FECredService.FiltroFechaType filtroFecha) {
	 ...
	 * @return filtroFecha
	 */
	public coop.guenoa.afip.FECredService.FiltroFechaType getFiltroFecha() {
		return filtroFecha;
	}
	 ...
	 * @param filtroFecha
	 */
	public void setFiltroFecha(coop.guenoa.afip.FECredService.FiltroFechaType filtroFecha) {
		this.filtroFecha = filtroFecha;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ConsultarFacturasAgtDptoCltvRequestType))
			return false;
		...
		_equals = true
				...
				&& ((this.filtroFecha == null && other.getFiltroFecha() == null)
						|| (this.filtroFecha != null && this.filtroFecha.equals(other.getFiltroFecha())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ConsultarFacturasAgtDptoCltvRequestType.class, true);
