...
public class EstadoCmpType implements java.io.Serializable {
	private coop.guenoa.afip.FECredService.EstadoCmpSimpleType estado;

	private java.util.Calendar fechaHoraEstado;

	public EstadoCmpType() {
	}

	public EstadoCmpType(coop.guenoa.afip.FECredService.EstadoCmpSimpleType estado,
	...
	/**
	 * Gets the estado value for this EstadoCmpType.
	 * 
	 * @return estado
	 */
	public coop.guenoa.afip.FECredService.EstadoCmpSimpleType getEstado() {
		return estado;
	}

	/**
	 * Sets the estado value for this EstadoCmpType.
	 * 
	 * @param estado
	 */
	public void setEstado(coop.guenoa.afip.FECredService.EstadoCmpSimpleType estado) {
		this.estado = estado;
	}

	/**
	 * Gets the fechaHoraEstado value for this EstadoCmpType.
	 * 
	...
	/**
	 * Sets the fechaHoraEstado value for this EstadoCmpType.
	 * 
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof EstadoCmpType))
			return false;
		EstadoCmpType other = (EstadoCmpType) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
