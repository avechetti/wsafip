/**
 * ConsultarCtaCteRequestType.java
 *
...
public class ConsultarCtaCteRequestType implements java.io.Serializable {
	...
	public ConsultarCtaCteRequestType() {
	}

	public ConsultarCtaCteRequestType(coop.guenoa.afip.FECredService.AuthRequestType authRequest,
	...
	/**
	 * Gets the authRequest value for this ConsultarCtaCteRequestType.
	 * 
	 * @return authRequest
	 */
	...
	/**
	 * Sets the authRequest value for this ConsultarCtaCteRequestType.
	 * 
	 * @param authRequest
	 */
	...
	/**
	 * Gets the idCtaCte value for this ConsultarCtaCteRequestType.
	 * 
	 * @return idCtaCte
	 */
	...
	/**
	 * Sets the idCtaCte value for this ConsultarCtaCteRequestType.
	 * 
	 * @param idCtaCte
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ConsultarCtaCteRequestType))
			return false;
		ConsultarCtaCteRequestType other = (ConsultarCtaCteRequestType) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ConsultarCtaCteRequestType.class, true);
