...
public class ServiceLocator extends org.apache.axis.client.Service implements coop.guenoa.afip.wscdc.IService {
	...
	private java.lang.String ServiceSoap_address = "https://wswhomo.afip.gov.ar/WSCDC/service.asmx";
	...
	public coop.guenoa.afip.wscdc.IServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
		try {
			coop.guenoa.afip.wscdc.ServiceSoapStub _stub = new coop.guenoa.afip.wscdc.ServiceSoapStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (coop.guenoa.afip.wscdc.IServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
				coop.guenoa.afip.wscdc.ServiceSoapStub _stub = new coop.guenoa.afip.wscdc.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
				_stub.setPortName(getServiceSoapWSDDServiceName());
				return _stub;
			}
