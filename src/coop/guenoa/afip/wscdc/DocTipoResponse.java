...
public class DocTipoResponse implements java.io.Serializable {
	private coop.guenoa.afip.wscdc.DocTipo[] resultGet;

	private coop.guenoa.afip.wscdc.Err[] errors;

	private coop.guenoa.afip.wscdc.Evt[] events;

	public DocTipoResponse() {
	}

	public DocTipoResponse(coop.guenoa.afip.wscdc.DocTipo[] resultGet, coop.guenoa.afip.wscdc.Err[] errors, coop.guenoa.afip.wscdc.Evt[] events) {
	...
	/**
	 * Gets the resultGet value for this DocTipoResponse.
	 * 
	 * @return resultGet
	 */
	public coop.guenoa.afip.wscdc.DocTipo[] getResultGet() {
		return resultGet;
	}

	/**
	 * Sets the resultGet value for this DocTipoResponse.
	 * 
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wscdc.DocTipo[] resultGet) {
		this.resultGet = resultGet;
	}

	/**
	 * Gets the errors value for this DocTipoResponse.
	 * 
	 * @return errors
	 */
	...
	/**
	 * Sets the errors value for this DocTipoResponse.
	 * 
	 * @param errors
	 */
	...
	/**
	 * Gets the events value for this DocTipoResponse.
	 * 
	 * @return events
	 */
	...
	/**
	 * Sets the events value for this DocTipoResponse.
	 * 
	 * @param events
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof DocTipoResponse))
			return false;
		DocTipoResponse other = (DocTipoResponse) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			DocTipoResponse.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicios1.afip.gob.ar/wscdc/", "DocTipoResponse"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://servicios1.afip.gob.ar/wscdc/", "DocTipo"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://servicios1.afip.gob.ar/wscdc/", "DocTipo"));
