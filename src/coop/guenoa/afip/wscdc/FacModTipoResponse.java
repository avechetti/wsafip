...
public class FacModTipoResponse implements java.io.Serializable {
	private coop.guenoa.afip.wscdc.FacModTipo[] resultGet;
	...
	public FacModTipoResponse(coop.guenoa.afip.wscdc.FacModTipo[] resultGet, coop.guenoa.afip.wscdc.Err[] errors, coop.guenoa.afip.wscdc.Evt[] events) {
	 ...
	 * @return resultGet
	 */
	public coop.guenoa.afip.wscdc.FacModTipo[] getResultGet() {
		return resultGet;
	}
	 ...
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wscdc.FacModTipo[] resultGet) {
		this.resultGet = resultGet;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof FacModTipoResponse))
			return false;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			FacModTipoResponse.class, true);

	static {
		typeDesc.setXmlType(
				new javax.xml.namespace.QName("http://servicios1.afip.gob.ar/wscdc/", "FacModTipoResponse"));
