...
public class CbteTipoResponse implements java.io.Serializable {
	private coop.guenoa.afip.wscdc.CbteTipo[] resultGet;

	private coop.guenoa.afip.wscdc.Err[] errors;

	private coop.guenoa.afip.wscdc.Evt[] events;

	public CbteTipoResponse() {
	}

	public CbteTipoResponse(coop.guenoa.afip.wscdc.CbteTipo[] resultGet, coop.guenoa.afip.wscdc.Err[] errors, coop.guenoa.afip.wscdc.Evt[] events) {
	...
	/**
	 * Gets the resultGet value for this CbteTipoResponse.
	 * 
	 * @return resultGet
	 */
	public coop.guenoa.afip.wscdc.CbteTipo[] getResultGet() {
		return resultGet;
	}

	/**
	 * Sets the resultGet value for this CbteTipoResponse.
	 * 
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wscdc.CbteTipo[] resultGet) {
		this.resultGet = resultGet;
	}

	/**
	 * Gets the errors value for this CbteTipoResponse.
	 * 
	 * @return errors
	 */
	...
	/**
	 * Sets the errors value for this CbteTipoResponse.
	 * 
	 * @param errors
	 */
	...
	/**
	 * Gets the events value for this CbteTipoResponse.
	 * 
	 * @return events
	 */
	...
	/**
	 * Sets the events value for this CbteTipoResponse.
	 * 
	 * @param events
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof CbteTipoResponse))
			return false;
		CbteTipoResponse other = (CbteTipoResponse) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			CbteTipoResponse.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicios1.afip.gob.ar/wscdc/", "CbteTipoResponse"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://servicios1.afip.gob.ar/wscdc/", "CbteTipo"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://servicios1.afip.gob.ar/wscdc/", "CbteTipo"));
