...
public class OpcionalTipoResponse implements java.io.Serializable {
	private coop.guenoa.afip.wscdc.OpcionalTipo[] resultGet;
	...
	public OpcionalTipoResponse(coop.guenoa.afip.wscdc.OpcionalTipo[] resultGet, coop.guenoa.afip.wscdc.Err[] errors, coop.guenoa.afip.wscdc.Evt[] events) {
	 ...
	 * @return resultGet
	 */
	public coop.guenoa.afip.wscdc.OpcionalTipo[] getResultGet() {
		return resultGet;
	}
	 ...
	 * @param resultGet
	 */
	public void setResultGet(coop.guenoa.afip.wscdc.OpcionalTipo[] resultGet) {
		this.resultGet = resultGet;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof OpcionalTipoResponse))
			return false;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			OpcionalTipoResponse.class, true);
	...
	static {
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://servicios1.afip.gob.ar/wscdc/", "OpcionalTipo"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://servicios1.afip.gob.ar/wscdc/", "OpcionalTipo"));
