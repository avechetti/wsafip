...
public class ServiceLocator extends org.apache.axis.client.Service implements coop.guenoa.afip.wsbfev1.IService {
	...
	private java.lang.String ServiceSoap_address = "http://wswhomo.afip.gov.ar/wsbfev1/service.asmx";
	...
	public coop.guenoa.afip.wsbfev1.IServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
		try {
			coop.guenoa.afip.wsbfev1.ServiceSoapStub _stub = new coop.guenoa.afip.wsbfev1.ServiceSoapStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (coop.guenoa.afip.wsbfev1.IServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
				coop.guenoa.afip.wsbfev1.ServiceSoapStub _stub = new coop.guenoa.afip.wsbfev1.ServiceSoapStub(new java.net.URL(ServiceSoap_address),
						this);
				_stub.setPortName(getServiceSoapWSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "Service");
	}
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "ServiceSoap"));
		}
