...
public class BFEResponse_Mon implements java.io.Serializable {
	private coop.guenoa.afip.wsbfev1.ClsBFEResponse_Mon[] BFEResultGet;

	private coop.guenoa.afip.wsbfev1.ClsBFEErr BFEErr;

	private coop.guenoa.afip.wsbfev1.ClsBFEEvents BFEEvents;

	public BFEResponse_Mon() {
	}

	public BFEResponse_Mon(coop.guenoa.afip.wsbfev1.ClsBFEResponse_Mon[] BFEResultGet, coop.guenoa.afip.wsbfev1.ClsBFEErr BFEErr,
	...
	/**
	 * Gets the BFEResultGet value for this BFEResponse_Mon.
	 * 
	 * @return BFEResultGet
	 */
	public coop.guenoa.afip.wsbfev1.ClsBFEResponse_Mon[] getBFEResultGet() {
		return BFEResultGet;
	}

	/**
	 * Sets the BFEResultGet value for this BFEResponse_Mon.
	 * 
	 * @param BFEResultGet
	 */
	public void setBFEResultGet(coop.guenoa.afip.wsbfev1.ClsBFEResponse_Mon[] BFEResultGet) {
		this.BFEResultGet = BFEResultGet;
	}

	/**
	 * Gets the BFEErr value for this BFEResponse_Mon.
	 * 
	 * @return BFEErr
	 */
	...
	/**
	 * Sets the BFEErr value for this BFEResponse_Mon.
	 * 
	 * @param BFEErr
	 */
	...
	/**
	 * Gets the BFEEvents value for this BFEResponse_Mon.
	 * 
	 * @return BFEEvents
	 */
	...
	/**
	 * Sets the BFEEvents value for this BFEResponse_Mon.
	 * 
	 * @param BFEEvents
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof BFEResponse_Mon))
			return false;
		BFEResponse_Mon other = (BFEResponse_Mon) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			BFEResponse_Mon.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "BFEResponse_Mon"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "ClsBFEResponse_Mon"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "ClsBFEResponse_Mon"));
