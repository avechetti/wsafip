...
public class BFEResponse_Tipo_Cbte implements java.io.Serializable {
	private coop.guenoa.afip.wsbfev1.ClsBFEResponse_Tipo_Cbte[] BFEResultGet;

	private coop.guenoa.afip.wsbfev1.ClsBFEErr BFEErr;

	private coop.guenoa.afip.wsbfev1.ClsBFEEvents BFEEvents;

	public BFEResponse_Tipo_Cbte() {
	}

	public BFEResponse_Tipo_Cbte(coop.guenoa.afip.wsbfev1.ClsBFEResponse_Tipo_Cbte[] BFEResultGet, coop.guenoa.afip.wsbfev1.ClsBFEErr BFEErr,
	...
	/**
	 * Gets the BFEResultGet value for this BFEResponse_Tipo_Cbte.
	 * 
	 * @return BFEResultGet
	 */
	public coop.guenoa.afip.wsbfev1.ClsBFEResponse_Tipo_Cbte[] getBFEResultGet() {
		return BFEResultGet;
	}

	/**
	 * Sets the BFEResultGet value for this BFEResponse_Tipo_Cbte.
	 * 
	 * @param BFEResultGet
	 */
	public void setBFEResultGet(coop.guenoa.afip.wsbfev1.ClsBFEResponse_Tipo_Cbte[] BFEResultGet) {
		this.BFEResultGet = BFEResultGet;
	}

	/**
	 * Gets the BFEErr value for this BFEResponse_Tipo_Cbte.
	 * 
	 * @return BFEErr
	 */
	...
	/**
	 * Sets the BFEErr value for this BFEResponse_Tipo_Cbte.
	 * 
	 * @param BFEErr
	 */
	...
	/**
	 * Gets the BFEEvents value for this BFEResponse_Tipo_Cbte.
	 * 
	 * @return BFEEvents
	 */
	...
	/**
	 * Sets the BFEEvents value for this BFEResponse_Tipo_Cbte.
	 * 
	 * @param BFEEvents
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof BFEResponse_Tipo_Cbte))
			return false;
		BFEResponse_Tipo_Cbte other = (BFEResponse_Tipo_Cbte) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			BFEResponse_Tipo_Cbte.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "BFEResponse_Tipo_Cbte"));
		...
		elemField
				.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "ClsBFEResponse_Tipo_Cbte"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(
				new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "ClsBFEResponse_Tipo_Cbte"));
