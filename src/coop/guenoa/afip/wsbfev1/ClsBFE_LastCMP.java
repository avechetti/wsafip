...
public class ClsBFE_LastCMP implements java.io.Serializable {
	...
	public ClsBFE_LastCMP() {
	}

	public ClsBFE_LastCMP(java.lang.String token, java.lang.String sign, long cuit, short pto_venta, short tipo_cbte) {
		this.token = token;
		this.sign = sign;
		this.cuit = cuit;
	...
	/**
	 * Gets the token value for this ClsBFE_LastCMP.
	 * 
	 * @return token
	 */
	...
	/**
	 * Sets the token value for this ClsBFE_LastCMP.
	 * 
	 * @param token
	 */
	...
	/**
	 * Gets the sign value for this ClsBFE_LastCMP.
	 * 
	 * @return sign
	 */
	...
	/**
	 * Sets the sign value for this ClsBFE_LastCMP.
	 * 
	 * @param sign
	 */
	...
	/**
	 * Gets the cuit value for this ClsBFE_LastCMP.
	 * 
	 * @return cuit
	 */
	public long getCuit() {
	...
	/**
	 * Sets the cuit value for this ClsBFE_LastCMP.
	 * 
	 * @param cuit
	 */
	...
	/**
	 * Gets the pto_venta value for this ClsBFE_LastCMP.
	 * 
	 * @return pto_venta
	 */
	...
	/**
	 * Sets the pto_venta value for this ClsBFE_LastCMP.
	 * 
	 * @param pto_venta
	 */
	...
	/**
	 * Gets the tipo_cbte value for this ClsBFE_LastCMP.
	 * 
	 * @return tipo_cbte
	 */
	...
	/**
	 * Sets the tipo_cbte value for this ClsBFE_LastCMP.
	 * 
	 * @param tipo_cbte
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ClsBFE_LastCMP))
			return false;
		ClsBFE_LastCMP other = (ClsBFE_LastCMP) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ClsBFE_LastCMP.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "ClsBFE_LastCMP"));
		...
		elemField.setXmlName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "Pto_venta"));
