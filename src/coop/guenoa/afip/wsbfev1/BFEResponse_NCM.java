...
public class BFEResponse_NCM implements java.io.Serializable {
	private coop.guenoa.afip.wsbfev1.ClsBFEResponse_NCM[] BFEResultGet;

	private coop.guenoa.afip.wsbfev1.ClsBFEErr BFEErr;

	private coop.guenoa.afip.wsbfev1.ClsBFEEvents BFEEvents;

	public BFEResponse_NCM() {
	}

	public BFEResponse_NCM(coop.guenoa.afip.wsbfev1.ClsBFEResponse_NCM[] BFEResultGet, coop.guenoa.afip.wsbfev1.ClsBFEErr BFEErr,
	...
	/**
	 * Gets the BFEResultGet value for this BFEResponse_NCM.
	 * 
	 * @return BFEResultGet
	 */
	public coop.guenoa.afip.wsbfev1.ClsBFEResponse_NCM[] getBFEResultGet() {
		return BFEResultGet;
	}

	/**
	 * Sets the BFEResultGet value for this BFEResponse_NCM.
	 * 
	 * @param BFEResultGet
	 */
	public void setBFEResultGet(coop.guenoa.afip.wsbfev1.ClsBFEResponse_NCM[] BFEResultGet) {
		this.BFEResultGet = BFEResultGet;
	}

	/**
	 * Gets the BFEErr value for this BFEResponse_NCM.
	 * 
	 * @return BFEErr
	 */
	...
	/**
	 * Sets the BFEErr value for this BFEResponse_NCM.
	 * 
	 * @param BFEErr
	 */
	...
	/**
	 * Gets the BFEEvents value for this BFEResponse_NCM.
	 * 
	 * @return BFEEvents
	 */
	...
	/**
	 * Sets the BFEEvents value for this BFEResponse_NCM.
	 * 
	 * @param BFEEvents
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof BFEResponse_NCM))
			return false;
		BFEResponse_NCM other = (BFEResponse_NCM) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			BFEResponse_NCM.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "BFEResponse_NCM"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "ClsBFEResponse_NCM"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.bfev1/", "ClsBFEResponse_NCM"));
