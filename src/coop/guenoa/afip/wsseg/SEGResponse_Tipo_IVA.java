...
public class SEGResponse_Tipo_IVA implements java.io.Serializable {
	private coop.guenoa.afip.wsseg.ClsSEGResponse_Tipo_IVA[] SEGResultGet;

	private coop.guenoa.afip.wsseg.ClsSEGErr SEGErr;

	private coop.guenoa.afip.wsseg.ClsSEGEvents SEGEvents;

	public SEGResponse_Tipo_IVA() {
	}

	public SEGResponse_Tipo_IVA(coop.guenoa.afip.wsseg.ClsSEGResponse_Tipo_IVA[] SEGResultGet, coop.guenoa.afip.wsseg.ClsSEGErr SEGErr,
	...
	/**
	 * Gets the SEGResultGet value for this SEGResponse_Tipo_IVA.
	 * 
	 * @return SEGResultGet
	 */
	public coop.guenoa.afip.wsseg.ClsSEGResponse_Tipo_IVA[] getSEGResultGet() {
		return SEGResultGet;
	}

	/**
	 * Sets the SEGResultGet value for this SEGResponse_Tipo_IVA.
	 * 
	 * @param SEGResultGet
	 */
	public void setSEGResultGet(coop.guenoa.afip.wsseg.ClsSEGResponse_Tipo_IVA[] SEGResultGet) {
		this.SEGResultGet = SEGResultGet;
	}

	/**
	 * Gets the SEGErr value for this SEGResponse_Tipo_IVA.
	 * 
	 * @return SEGErr
	 */
	...
	/**
	 * Sets the SEGErr value for this SEGResponse_Tipo_IVA.
	 * 
	 * @param SEGErr
	 */
	...
	/**
	 * Gets the SEGEvents value for this SEGResponse_Tipo_IVA.
	 * 
	 * @return SEGEvents
	 */
	...
	/**
	 * Sets the SEGEvents value for this SEGResponse_Tipo_IVA.
	 * 
	 * @param SEGEvents
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof SEGResponse_Tipo_IVA))
			return false;
		SEGResponse_Tipo_IVA other = (SEGResponse_Tipo_IVA) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			SEGResponse_Tipo_IVA.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.seg/", "SEGResponse_Tipo_IVA"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.seg/", "ClsSEGResponse_Tipo_IVA"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.seg/", "ClsSEGResponse_Tipo_IVA"));
