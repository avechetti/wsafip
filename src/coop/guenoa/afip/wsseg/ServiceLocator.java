...
public class ServiceLocator extends org.apache.axis.client.Service implements coop.guenoa.afip.wsseg.Service {
	...
	private java.lang.String ServiceSoap_address = "https://wswhomo.afip.gov.ar/wsseg/service.asmx";
	...
	public coop.guenoa.afip.wsseg.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
		try {
			coop.guenoa.afip.wsseg.ServiceSoapStub _stub = new coop.guenoa.afip.wsseg.ServiceSoapStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (coop.guenoa.afip.wsseg.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
				coop.guenoa.afip.wsseg.ServiceSoapStub _stub = new coop.guenoa.afip.wsseg.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
				_stub.setPortName(getServiceSoapWSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://ar.gov.afip.dif.seg/", "Service");
	}
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName("http://ar.gov.afip.dif.seg/", "ServiceSoap"));
		}
