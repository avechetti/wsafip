...
public class ClsSEGRequest implements java.io.Serializable {
	private long id;
	...
	public ClsSEGRequest() {
	}

	public ClsSEGRequest(long id, short tipo_doc, long nro_doc, short tipo_cbte, int punto_vta, long cbte_nro,
			double imp_total, double imp_tot_conc, double imp_neto, double impto_liq, double impto_liq_rni,
			double imp_op_ex, double imp_perc, double imp_iibb, double imp_perc_mun, double imp_internos,
			java.lang.String imp_moneda_Id, double imp_moneda_ctz, double imp_otrib_prov, java.lang.String fecha_cbte,
			coop.guenoa.afip.wsseg.Item[] items) {
		this.id = id;
	...
	/**
	 * Gets the id value for this ClsSEGRequest.
	 * 
	 * @return id
	 */
	public long getId() {
	...
	/**
	 * Sets the id value for this ClsSEGRequest.
	 * 
	 * @param id
	 */
	...
	/**
	 * Gets the tipo_doc value for this ClsSEGRequest.
	 * 
	 * @return tipo_doc
	 */
	...
	/**
	 * Sets the tipo_doc value for this ClsSEGRequest.
	 * 
	 * @param tipo_doc
	 */
	...
	/**
	 * Gets the nro_doc value for this ClsSEGRequest.
	 * 
	 * @return nro_doc
	 */
	...
	/**
	 * Sets the nro_doc value for this ClsSEGRequest.
	 * 
	 * @param nro_doc
	 */
	...
	/**
	 * Gets the tipo_cbte value for this ClsSEGRequest.
	 * 
	 * @return tipo_cbte
	 */
	...
	/**
	 * Sets the tipo_cbte value for this ClsSEGRequest.
	 * 
	 * @param tipo_cbte
	 */
	...
	/**
	 * Gets the punto_vta value for this ClsSEGRequest.
	 * 
	 * @return punto_vta
	 */
	...
	/**
	 * Sets the punto_vta value for this ClsSEGRequest.
	 * 
	 * @param punto_vta
	 */
	...
	/**
	 * Gets the cbte_nro value for this ClsSEGRequest.
	 * 
	 * @return cbte_nro
	 */
	...
	/**
	 * Sets the cbte_nro value for this ClsSEGRequest.
	 * 
	 * @param cbte_nro
	 */
	...
	/**
	 * Gets the imp_total value for this ClsSEGRequest.
	 * 
	 * @return imp_total
	 */
	...
	/**
	 * Sets the imp_total value for this ClsSEGRequest.
	 * 
	 * @param imp_total
	 */
	...
	/**
	 * Gets the imp_tot_conc value for this ClsSEGRequest.
	 * 
	 * @return imp_tot_conc
	 */
	...
	/**
	 * Sets the imp_tot_conc value for this ClsSEGRequest.
	 * 
	 * @param imp_tot_conc
	 */
	...
	/**
	 * Gets the imp_neto value for this ClsSEGRequest.
	 * 
	 * @return imp_neto
	 */
	...
	/**
	 * Sets the imp_neto value for this ClsSEGRequest.
	 * 
	 * @param imp_neto
	 */
	...
	/**
	 * Gets the impto_liq value for this ClsSEGRequest.
	 * 
	 * @return impto_liq
	 */
	...
	/**
	 * Sets the impto_liq value for this ClsSEGRequest.
	 * 
	 * @param impto_liq
	 */
	...
	/**
	 * Gets the impto_liq_rni value for this ClsSEGRequest.
	 * 
	...
	/**
	 * Sets the impto_liq_rni value for this ClsSEGRequest.
	 * 
	 * @param impto_liq_rni
	 */
	...
	/**
	 * Gets the imp_op_ex value for this ClsSEGRequest.
	 * 
	 * @return imp_op_ex
	 */
	...
	/**
	 * Sets the imp_op_ex value for this ClsSEGRequest.
	 * 
	 * @param imp_op_ex
	 */
	...
	/**
	 * Gets the imp_perc value for this ClsSEGRequest.
	 * 
	 * @return imp_perc
	 */
	...
	/**
	 * Sets the imp_perc value for this ClsSEGRequest.
	 * 
	 * @param imp_perc
	 */
	...
	/**
	 * Gets the imp_iibb value for this ClsSEGRequest.
	 * 
	 * @return imp_iibb
	 */
	...
	/**
	 * Sets the imp_iibb value for this ClsSEGRequest.
	 * 
	 * @param imp_iibb
	 */
	...
	/**
	 * Gets the imp_perc_mun value for this ClsSEGRequest.
	 * 
	 * @return imp_perc_mun
	 */
	...
	/**
	 * Sets the imp_perc_mun value for this ClsSEGRequest.
	 * 
	 * @param imp_perc_mun
	 */
	...
	/**
	 * Gets the imp_internos value for this ClsSEGRequest.
	 * 
	 * @return imp_internos
	 */
	...
	/**
	 * Sets the imp_internos value for this ClsSEGRequest.
	 * 
	 * @param imp_internos
	 */
	...
	/**
	 * Gets the imp_moneda_Id value for this ClsSEGRequest.
	 * 
	...
	/**
	 * Sets the imp_moneda_Id value for this ClsSEGRequest.
	 * 
	 * @param imp_moneda_Id
	 */
	...
	/**
	 * Gets the imp_moneda_ctz value for this ClsSEGRequest.
	 * 
	...
	/**
	 * Sets the imp_moneda_ctz value for this ClsSEGRequest.
	 * 
	...
	/**
	 * Gets the imp_otrib_prov value for this ClsSEGRequest.
	 * 
	...
	/**
	 * Sets the imp_otrib_prov value for this ClsSEGRequest.
	 * 
	...
	/**
	 * Gets the fecha_cbte value for this ClsSEGRequest.
	 * 
	 * @return fecha_cbte
	 */
	...
	/**
	 * Sets the fecha_cbte value for this ClsSEGRequest.
	 * 
	 * @param fecha_cbte
	 */
	...
	/**
	 * Gets the items value for this ClsSEGRequest.
	 * 
	 * @return items
	 */
	...
	/**
	 * Sets the items value for this ClsSEGRequest.
	 * 
	 * @param items
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ClsSEGRequest))
			return false;
		ClsSEGRequest other = (ClsSEGRequest) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
		...
		_equals = true && this.id == other.getId() && this.tipo_doc == other.getTipo_doc()
				&& this.nro_doc == other.getNro_doc() && this.tipo_cbte == other.getTipo_cbte()
				&& this.punto_vta == other.getPunto_vta() && this.cbte_nro == other.getCbte_nro()
				&& this.imp_total == other.getImp_total() && this.imp_tot_conc == other.getImp_tot_conc()
				&& this.imp_neto == other.getImp_neto() && this.impto_liq == other.getImpto_liq()
				&& this.impto_liq_rni == other.getImpto_liq_rni() && this.imp_op_ex == other.getImp_op_ex()
				&& this.imp_perc == other.getImp_perc() && this.imp_iibb == other.getImp_iibb()
				&& this.imp_perc_mun == other.getImp_perc_mun() && this.imp_internos == other.getImp_internos()
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ClsSEGRequest.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.seg/", "ClsSEGRequest"));
		...
		elemField.setXmlName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.seg/", "Fecha_cbte"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
