...
public class SEGResponse_LastID implements java.io.Serializable {
	private coop.guenoa.afip.wsseg.ClsSEGResponse_LastID SEGResultGet;

	private coop.guenoa.afip.wsseg.ClsSEGErr SEGErr;

	private coop.guenoa.afip.wsseg.ClsSEGEvents SEGEvents;

	public SEGResponse_LastID() {
	}

	public SEGResponse_LastID(coop.guenoa.afip.wsseg.ClsSEGResponse_LastID SEGResultGet, coop.guenoa.afip.wsseg.ClsSEGErr SEGErr,
	...
	/**
	 * Gets the SEGResultGet value for this SEGResponse_LastID.
	 * 
	 * @return SEGResultGet
	 */
	public coop.guenoa.afip.wsseg.ClsSEGResponse_LastID getSEGResultGet() {
		return SEGResultGet;
	}

	/**
	 * Sets the SEGResultGet value for this SEGResponse_LastID.
	 * 
	 * @param SEGResultGet
	 */
	public void setSEGResultGet(coop.guenoa.afip.wsseg.ClsSEGResponse_LastID SEGResultGet) {
		this.SEGResultGet = SEGResultGet;
	}

	/**
	 * Gets the SEGErr value for this SEGResponse_LastID.
	 * 
	 * @return SEGErr
	 */
	...
	/**
	 * Sets the SEGErr value for this SEGResponse_LastID.
	 * 
	 * @param SEGErr
	 */
	...
	/**
	 * Gets the SEGEvents value for this SEGResponse_LastID.
	 * 
	 * @return SEGEvents
	 */
	...
	/**
	 * Sets the SEGEvents value for this SEGResponse_LastID.
	 * 
	 * @param SEGEvents
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof SEGResponse_LastID))
			return false;
		SEGResponse_LastID other = (SEGResponse_LastID) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			SEGResponse_LastID.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.seg/", "SEGResponse_LastID"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.seg/", "ClsSEGResponse_LastID"));
