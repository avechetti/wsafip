...
public class ClsSEGGetCMP implements java.io.Serializable {
	...
	public ClsSEGGetCMP(short tipo_cbte, int punto_vta, long cbte_nro) {
	...
	/**
	 * Gets the tipo_cbte value for this ClsSEGGetCMP.
	 * 
	 * @return tipo_cbte
	 */
	...
	/**
	 * Sets the tipo_cbte value for this ClsSEGGetCMP.
	 * 
	 * @param tipo_cbte
	 */
	...
	/**
	 * Gets the punto_vta value for this ClsSEGGetCMP.
	 * 
	 * @return punto_vta
	 */
	...
	/**
	 * Sets the punto_vta value for this ClsSEGGetCMP.
	 * 
	 * @param punto_vta
	 */
	...
	/**
	 * Gets the cbte_nro value for this ClsSEGGetCMP.
	 * 
	 * @return cbte_nro
	 */
	...
	/**
	 * Sets the cbte_nro value for this ClsSEGGetCMP.
	 * 
	 * @param cbte_nro
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ClsSEGGetCMP))
			return false;
		ClsSEGGetCMP other = (ClsSEGGetCMP) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ClsSEGGetCMP.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.seg/", "ClsSEGGetCMP"));
