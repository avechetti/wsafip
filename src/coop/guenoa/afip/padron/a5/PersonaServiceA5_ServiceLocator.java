...
public class PersonaServiceA5_ServiceLocator extends org.apache.axis.client.Service implements coop.guenoa.afip.padron.a5.PersonaServiceA5_Service {
    ...
    private java.lang.String PersonaServiceA5Port_address = "https://awshomo.afip.gov.ar/sr-padron/webservices/personaServiceA5";
    ...
    public coop.guenoa.afip.padron.a5.PersonaServiceA5_PortType getPersonaServiceA5Port() throws javax.xml.rpc.ServiceException {
    ...
    public coop.guenoa.afip.padron.a5.PersonaServiceA5_PortType getPersonaServiceA5Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            coop.guenoa.afip.padron.a5.PersonaServiceA5SoapBindingStub _stub = new coop.guenoa.afip.padron.a5.PersonaServiceA5SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (coop.guenoa.afip.padron.a5.PersonaServiceA5_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                coop.guenoa.afip.padron.a5.PersonaServiceA5SoapBindingStub _stub = new coop.guenoa.afip.padron.a5.PersonaServiceA5SoapBindingStub(new java.net.URL(PersonaServiceA5Port_address), this);
                _stub.setPortName(getPersonaServiceA5PortWSDDServiceName());
                return _stub;
            }
        }
