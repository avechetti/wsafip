...
public class DatosRegimenGeneral  implements java.io.Serializable {
    ...
    private coop.guenoa.afip.padron.a5.Categoria categoriaAutonomo;

    private coop.guenoa.afip.padron.a5.Impuesto[] impuesto;

    private coop.guenoa.afip.padron.a5.Regimen[] regimen;
    ...
    public DatosRegimenGeneral(
           ...
           coop.guenoa.afip.padron.a5.Categoria categoriaAutonomo,
           coop.guenoa.afip.padron.a5.Impuesto[] impuesto,
           coop.guenoa.afip.padron.a5.Regimen[] regimen) {
     ...
     */
    public coop.guenoa.afip.padron.a5.Categoria getCategoriaAutonomo() {
        return categoriaAutonomo;
    }
     ...
     */
    public void setCategoriaAutonomo(coop.guenoa.afip.padron.a5.Categoria categoriaAutonomo) {
        this.categoriaAutonomo = categoriaAutonomo;
    }
     ...
     * @return regimen
     */
    public coop.guenoa.afip.padron.a5.Regimen[] getRegimen() {
        return regimen;
    }
     ...
     * @param regimen
     */
    public void setRegimen(coop.guenoa.afip.padron.a5.Regimen[] regimen) {
        this.regimen = regimen;
    }

    public coop.guenoa.afip.padron.a5.Regimen getRegimen(int i) {
        return this.regimen[i];
    }

    public void setRegimen(int i, coop.guenoa.afip.padron.a5.Regimen _value) {
